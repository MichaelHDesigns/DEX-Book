...
<div className="flex flex-row justify-center">
    <div className="relative group items-center">
        ...
        <button
            className="group w-32 h-12 m-2 btn animate-pulse bg-gradient-to-br from-indigo-500 to-fuchsia-500 hover:from-white hover:to-purple-300 text-black rounded-full"
